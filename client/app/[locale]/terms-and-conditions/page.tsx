  ...
  return (
    <article>
      ...
      <p>
        ...
        <a href="https://www.referalah.com/">https://www.referalah.com/</a> (the
      ...
      <p>
        ...
        Referalah, concerning your access to and use of the Services. You agree
        ...
        these terms, then you are expressly prohibited from using the services
      ...
      <ul>
        ...
        <li>
          Your Contributions are not false, inaccurate, or misleading, and shall
          be made acting in good faith.
        </li>
        <li>
        ...
        <li>
          Your Contributions do not promote violence against a specific person
          or class of people.
        </li>
        <li>
      ...
      <p>
        ...
        jurisdiction of the Canada courts. Referalah shall also maintain the
      ...
      <p>
        ...
        content or the content of any website or mobile applications linked to
        the services, or content posted by other users and w will assume no
        ...
        user or any third party through the services, any hyperlinked website,
      ...
      <p>
        ...
        contracts, orders and other records, and other records, and to
