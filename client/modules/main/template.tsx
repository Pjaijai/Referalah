  ...
  return (
    <>
      <div className="relative mt-2 flex h-screen w-full flex-row items-center justify-center md:h-auto">
        <div className="relative z-30 mx-auto h-full w-full max-w-7xl overflow-hidden px-4  md:h-[40rem]">
          <motion.div
            initial={{
              opacity: 0,
              y: 20,
          ...
          >
            <div className="flex flex-col items-center justify-center text-6xl font-bold text-black dark:text-white md:flex-row md:text-4xl">
